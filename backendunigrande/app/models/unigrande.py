...
class Professor(models.Model):
    ...
    id: int = fields.IntField(pk=True)
    matricula: "int | None" = fields.IntField(null=True)
...
class Matriz(models.Model):
    ...
    curso: "Curso" = fields.ForeignKeyField("models.Curso", related_name="matrizes")
    ...
    def __str__(self) -> str:
        ...
        disciplina_nome = (
            self.disciplina.nome if self.disciplina else "Disciplina não definida"
        )
...
class Turma(models.Model):
    ...
    def __str__(self) -> str:
        info_disciplina = (
            self.disciplina.nome if self.disciplina else "Disciplina Indefinida"
        )

        info_periodo = (
            str(self.periodo_letivo) if self.periodo_letivo else "Período Indefinido"
        )
...
class Aluno(models.Model):
    ...
    mgp: "Decimal | None" = fields.DecimalField(
...
class Matricula(models.Model):
    ...
    nota_01: "Decimal | None" = fields.DecimalField(
        max_digits=5, decimal_places=2, null=True
    )
    nota_02: "Decimal | None" = fields.DecimalField(
        max_digits=5, decimal_places=2, null=True
    )
    nota_03: "Decimal | None" = fields.DecimalField(
        max_digits=5, decimal_places=2, null=True
    )
...
class Historico(models.Model):
    ...
    aluno: "Aluno" = fields.ForeignKeyField("models.Aluno", related_name="historicos")
    situacao: str = fields.CharField(max_length=2)  # AP/RE/TC/MT, etc.
    media_final: "Decimal | None" = fields.DecimalField(max_digits=5, decimal_places=2, null=True)
    ...
    def __str__(self) -> str:
        ...
        nome_disciplina = (
            self.disciplina.nome if self.disciplina else "Disciplina inválida"
        )
