...
COMMENT ON TABLE "periodos_letivos" IS 'Representa um semestre acadêmico específico, como 2025.1. ';
...
COMMENT ON TABLE "professores" IS 'Representa um docente cadastrado no sistema da universidade. ';
...
COMMENT ON TABLE "cursos" IS 'São os Cursos da Universidade. ';
...
COMMENT ON TABLE "alunos" IS 'Aluno, com todos seus atributos e conexões.';
...
COMMENT ON TABLE "historicos" IS 'Resultado final do aluno em uma disciplina em um ano/semestre';
...
COMMENT ON TABLE "matrizes" IS 'Currículo, qual disciplina pertence a qual curso e em qual período.';
...
COMMENT ON TABLE "turmas" IS 'São as Turmas, oferta da disciplina no período letivo, com professor e vagas. ';
...
COMMENT ON TABLE "matriculas" IS 'Matrícula do Aluno, com suas respectivas notas e faltas';
